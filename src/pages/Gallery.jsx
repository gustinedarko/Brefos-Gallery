        ...
        {gallery.map((item, index) => {
          ...
          return (
            ...
            >
              ...
              <div
                className={`${ratio} w-full overflow-hidden group relative rounded-2xl shadow-lg hover:shadow-2xl transition duration-300`}
              >
                <img
                  src={item.image}
                  alt={item.title}
                ...
                {/* ---- OVERLAY FOR DESKTOP ---- */}
                <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-500 hidden md:flex flex-col justify-end p-5 text-white rounded-2xl">
