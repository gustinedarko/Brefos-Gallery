import oneVision from "../assets/images/one-vision.webp";
import oneVisionFramed from "../assets/images/one-vision-framed.webp";
import heartThatGave from "../assets/images/heart-that-gave.webp";
import heartThatGaveFramed from "../assets/images/heart-that-gave-framed.webp";
import alpha from "../assets/images/alpha.webp";
import alphaFramed from "../assets/images/alpha-framed.webp";
import guiltyDomain from "../assets/images/guilty-domain.webp";
import guiltyDomainFramed from "../assets/images/guilty-domain-framed.webp";
import lifesParadox from "../assets/images/lifes-paradox.webp";
import lifesParadoxFramed from "../assets/images/lifes-paradox-framed.webp";
import mehoOmo from "../assets/images/meho-omo-i-have-seen-them.webp";
import mehoOmoFramed from "../assets/images/meho-omo-i-have-seen-them-framed.webp";
import metamorphosis from "../assets/images/metamorphosis-of-the-soul.webp";
import metamorphosisFramed from "../assets/images/metamorphosis-of-the-soul-framed.webp";
import mrChuck from "../assets/images/mr-chuck.webp";
import mrChuckFramed from "../assets/images/mr-chuck-framed.webp";
import omega from "../assets/images/omega.webp";
import omegaFramed from "../assets/images/omega-framed.webp";
import queSera from "../assets/images/que-sera-sera.webp";
import queSeraFramed from "../assets/images/que-sera-sera-framed.webp";
import beautyOfAllColors from "../assets/images/the-beauty-of-all-colors.webp";
import beautyOfAllColorsFramed from "../assets/images/the-beauty-of-all-colors-framed.webp";
import beingWithCracks from "../assets/images/the-being-with-cracks.webp";
import beingWithCracksFramed from "../assets/images/the-being-with-cracks-framed.webp";
import complexityOfThought from "../assets/images/the-complexity-of-thoughtful-emotions.webp";
import complexityOfThoughtFramed from "../assets/images/the-complexity-of-thoughtful-emotions-framed.webp";
import confessionOldWoman from "../assets/images/the-confession-of-the-brilliant-old-woman.webp";
import confessionOldWomanFramed from "../assets/images/the-confession-of-the-brilliant-old-woman-framed.webp";
import feelOfExistence from "../assets/images/the-feel-of-existence-in-a-life-chosen-for.webp";
import feelOfExistenceFramed from "../assets/images/the-feel-of-existence-in-a-life-chosen-for-framed.webp";
import healer from "../assets/images/the-healer.webp";
import healerFramed from "../assets/images/the-healer-framed.webp";
import iconicHerd from "../assets/images/the-iconic-herd.webp";
import iconicHerdFramed from "../assets/images/the-iconic-herd-framed.webp";
import lastProphet from "../assets/images/the-last-prophet.webp";
import lastProphetFramed from "../assets/images/the-last-prophet-framed.webp";
import prayerArchangel from "../assets/images/the-prayer-to-the-first-archangel.webp";
import prayerArchangelFramed from "../assets/images/the-prayer-to-the-first-archangel-framed.webp";
import soulWithTurtleNeck from "../assets/images/the-soul-with-the-turtle-neck.webp";
import soulWithTurtleNeckFramed from "../assets/images/the-soul-with-the-turtle-neck-framed.webp";
import timeTraveler from "../assets/images/the-time-traveler.webp";
import timeTravelerFramed from "../assets/images/the-time-traveler-framed.webp";
import transfiguration from "../assets/images/the-transfiguration.webp";
import transfigurationFramed from "../assets/images/the-transfiguration-framed.webp";
import untoldStories from "../assets/images/the-untold-stories.webp";
import untoldStoriesFramed from "../assets/images/the-untold-stories-framed.webp";
import wish from "../assets/images/the-wish.webp";
import wishFramed from "../assets/images/the-wish-framed.webp";
import veritas from "../assets/images/veritas.webp";
import veritasFramed from "../assets/images/veritas-framed.webp";
import weCantEscapeIt from "../assets/images/we-cant-escape-it.webp";
import weCantEscapeItFramed from "../assets/images/we-cant-escape-it-framed.webp";
import whyTogether from "../assets/images/why-together.webp";
import whyTogetherFramed from "../assets/images/why-together-framed.webp";
import disbelieva from "../assets/images/disbelieva.webp";
import disbelievaFramed from "../assets/images/disbelieva-framed.webp";
import perfectMind from "../assets/images/perfect-mind.webp";
import perfectMindFramed from "../assets/images/perfect-mind-framed.webp";
import sadGeneration from "../assets/images/sad-generation.webp";
import sadGenerationFramed from "../assets/images/sad-generation-framed.webp";
import soulAbduction from "../assets/images/soul-abduction.webp";
import soulAbductionFramed from "../assets/images/soul-abduction-framed.webp";
import bestWorstThing from "../assets/images/best-worst-thing.webp";
import bestWorstThingFramed from "../assets/images/best-worst-thing-framed.webp";
import generationOmega from "../assets/images/generation-omega.webp";
...
export const gallery = [
  ...
  },
  {
    ...
    materials: "Acrylics on canvas",
    size: "34 x 32 inches",
    description: "I'm truly broken, and I just want today to be the end of this life. I am actually entering a state that no one wishes for because of this forced life journey that I'm going through. Why is life run this way, why does it favor a select few, and why is it chock-full of falsehoods and sorrow? How is it that everything we see here is meant to eradicate us? I implore everyone to play a role in fostering peace, to believe in the journey of life even though we are unsure of its conclusion, and to hope for a happy afterlife.",
    year: 2023,
    type: "square" // or "portrait" or "square"
  },
  {
    ...
    materials: "Acrylics on canvas",
    size: "24 x 24 inches",
    description: `I am an old woman who has been through life’s ups and downs. There are always going to be ups and downs, even though it seems like a transient situation. You know, maintaining composure is key to this life. It all comes down to maintaining composure and refusing to allow life's ups and downs get to you. You learn to let go of things you cannot control and concentrate on the things you can, which makes it really awesome. In addition, living virtuously and being a decent person are vital. Seems like a good fit for your optimistic approach to living. This wisdom has caused me much remorse, especially at this advanced age. You have to realise that the happiness you project onto the people watching you via your image affects them in return. For this reason, one should remember the purpose of life, put aside anxieties, and simply enjoy it. What is going to happen is going to happen, no doubt about it. Simply put, doubting yourself undermines your spirituality and creates a barrier to what can be attracted to you. “WE CANNOT BE PRESENT IF WE ARE LOOKING BACKWARDS. “`,
    year: 2024,
    type: "square" // or "portrait" or "square"
  },
  {
    ...
    materials: "Mixed media on canvas",
    size: "24 x 24 inches",
    description: "For many people, life's the most difficult phase has been existence. Life favours and supports only those who possess greater possibilities and privileges. The struggle to get what will bring us happiness is a losing one for those of us with little or no options in life. Nothing like that ever occurs, even though we are always searching for strategies to survive. Because of this, we experience a variety of unpleasant emotions on a daily basis. This depends on the situation in which an individual finds themselves. The situation changes in many ways, but ultimately, realise that life is just a transitory adventure, therefore find inner peace with yourself.",
    year: 2024,
    type: "square" // or "portrait" or "square"
  },
  {
  ...
  },
  {
    ...
    materials: "Acrylics on canvas",
    size: "34 x 32 inches",
    description: "I am an innocent person who made an effort to live a life distinct from that of everyone else. I made an effort to examine everything and refrain from thinking or acting the way they had instructed us to. As soon as they caught on, they attempted to erase everything I had learned about them, altered me beyond recognition, covered and restrained my mouth to prevent me from speaking out against what I had witnessed, and attempted to cover my body to prevent anyone from witnessing what they had done to me. They are thirteen elites when I saw them. Be mindful of them.",
    year: 2023,
    type: "square" // or "portrait" or "square"
  },
  {
    ...
    materials: "Mixed media on canvas",
    size: "24 x 24 inches",
    description: `"The Transfiguration" is a poignant artwork that captures the transformative power of change, symbolizing the journey from adversity to triumph through vibrant flowers surrounding two women. The piece celebrates human resilience, growth, and transformation, reminding us that even in darkness, there's potential for beauty, hope, and renewal.`,
    year: 2025,
    type: "square" // or "portrait" or "square"
  },
  {
    ...
    materials: "Mixed media on canvas",
    size: "70 x 40 inches",
    description: "Togetherness, intelligence, strength and unity. Guess we need this.",
    year: 2025,
    type: "landscape" // or "portrait" or "square"
  },
  {
  ...
  },
  {
    ...
    materials: "Acrylics on canvas",
    size: "48 x 36 inches",
    description: "I am a piece that unveils some obscure mysteries. A select few people have removed me from the view of many. Even so, it's fascinating. The diversity and allure of culture are immense. Africa is home to numerous distinct nations and regions, each with its own generation-to generation traditions, rituals, and customs. It's a beautiful and storied tapestry, indeed. There are undiscovered tales of this vibrant culture and mysteries that must be revealed. It has the potential to significantly alter the universe, satisfy many needs, and provide answers to some of the biggest mysteries.",
    year: 2024,
    type: "portrait" // or "portrait" or "square"
  },
  {
  ...
  },
  {
    ...
    materials: "Mixed media on canvas",
    size: "53 x 40 inches",
    description: "Love can often appear radiant and flawless on the surface, a beautiful facade that captivates and inspires. However, beneath this gleaming exterior, love can be a complex and messy entity, fraught with challenges, heartaches, and uncertainties. The reality of love can be a delicate balance of compromise, sacrifice, and vulnerability, where emotions ebb and flow like the tides. Despite its beauty, love can also be a breeding ground for conflicts, misunderstandings, and pain, testing the bonds between individuals and pushing them to their limits. Ultimately, love's true nature is often revealed in the imperfections, the struggles, and the quiet moments of introspection, where its beauty and ugliness coexist in a delicate dance.",
    year: 2025,
    type: "portrait" // or "portrait" or "square"
  },
  {
